...
const Pencarian = () => {
  ...
  const images = [
      {
        id: 1,
        src: "/public/static/images/pencarian-1.jpg",
        text: "Aroma Terbaik Parfum Pria 50ML",
        price: "Rp75.000",
        location: "Jakarta",
        rating: "4.8",
        sold: "250",
      ...
      {
        id: 2,
        src: "/public/static/images/pencarian-2.jpg",
        text: "Elegan Parfum Wanita 50ML",
        price: "Rp80.000",
        location: "Surabaya",
        rating: "4.6",
        sold: "300",
      ...
      {
        id: 3,
        src: "/public/static/images/pencarian-3.jpg",
        text: "Harum Alami Parfum Unisex 100ML",
        price: "Rp120.000",
        location: "Bandung",
        rating: "4.7",
        sold: "500",
      ...
      {
        id: 4,
        src: "/public/static/images/pencarian-4.jpg",
        text: "Fresh Citrus Parfum Pria 75ML",
        price: "Rp90.000",
        location: "Yogyakarta",
        rating: "4.5",
        sold: "400",
      ...
      {
        id: 5,
        src: "/public/static/images/pencarian-5.jpg",
        text: "Floral Delight Parfum Wanita 50ML",
        price: "Rp70.000",
        location: "Semarang",
        rating: "4.4",
        sold: "350",
      ...
      {
        id: 6,
        src: "/public/static/images/pencarian-6.jpg",
        text: "Bold Spice Parfum Pria 50ML",
        price: "Rp85.000",
        location: "Medan",
        rating: "4.9",
        sold: "200",
      ...
      {
        id: 7,
        src: "/public/static/images/pencarian-7.jpg",
        text: "Luxury Scent Parfum Wanita 100ML",
        price: "Rp150.000",
        location: "Bali",
        rating: "4.7",
        sold: "420",
  ...
  return (
    <div className="rounded-lg shadow-inner bg-slate-50 py-3 px-4 my-4 hidden sm:block font-inter">
      <div className="my-2 flex font-bold self-end items-end">
        <p className="mx-2 text-xl">Berdasarkan Pencarianmu</p>
        ...
        <div className="carousel-item w-full">
          <div className="w-full flex justify-evenly">
            {currentImages.map((imageIndex, idx) => (
              <div key={idx} className="shadow w-[110px] h-[280px] lg:w-[175px] lg:h-[320px]">
                ...
                <div className="px-2 rounded-b-lg my-2 py-2 ">
                  <p className="text-base -tracking-wide">{images[imageIndex].text}</p>
